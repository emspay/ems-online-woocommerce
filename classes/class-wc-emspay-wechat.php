...
class WC_Emspay_WeChat extends WC_Emspay_Gateway
{
    /**
     * WC_Emspay_WeChat constructor.
     */
    public function __construct()
    {
        $this->id = 'emspay_wechat';
        $this->icon = false;
        $this->has_fields = false;
        $this->method_title = __('WeChat - EMS Online', WC_Emspay_Helper::DOMAIN);
        $this->method_description = __('WeChat - EMS Online', WC_Emspay_Helper::DOMAIN);
