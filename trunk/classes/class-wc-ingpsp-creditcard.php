...
class WC_Ingpsp_Creditcard extends WC_Ingpsp_Gateway
{
    /**
    ...
    {
        $this->id = 'ingpsp_creditcard';
        $this->icon = false;
        $this->has_fields = false;
        $this->method_title = __('Mastercard, VISA, Maestro or V PAY - ING PSP', WC_Ingpsp_Helper::DOMAIN);
        $this->method_description = __('Mastercard, VISA, Maestro or V PAY - ING PSP', WC_Ingpsp_Helper::DOMAIN);
    ...
    public function process_payment($order_id)
    {
        ...
        $ingOrder = $this->ing->createCreditCardOrder(
