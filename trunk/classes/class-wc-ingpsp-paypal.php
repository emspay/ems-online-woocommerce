...
class WC_Ingpsp_PayPal extends WC_Ingpsp_Gateway
{
    /**
    ...
    {
        $this->id = 'ingpsp_paypal';
        $this->icon = false;
        $this->has_fields = false;
        $this->method_title = __('PayPal - ING PSP', WC_Ingpsp_Helper::DOMAIN);
        $this->method_description = __('PayPal - ING PSP', WC_Ingpsp_Helper::DOMAIN);
    ...
    public function process_payment($order_id)
    {
        ...
        $ingOrder = $this->ing->createPaypalOrder(
