...
class WC_Ingpsp_Sofort extends WC_Ingpsp_Gateway
{
    /**
    ...
    {
        $this->id = 'ingpsp_sofort';
        $this->icon = false;
        $this->has_fields = false;
        $this->method_title = __('ING PSP - SOFORT', WC_Ingpsp_Helper::DOMAIN);
        $this->method_description = __('ING PSP - SOFORT', WC_Ingpsp_Helper::DOMAIN);
    ...
    public function process_payment($order_id)
    {
        ...
        $ingOrder = $this->ing->createSofortOrder(
