...
class WC_Emspay_Callback extends WC_Emspay_Gateway
{
    ...
    public function handle_callback()
    {
        ...
        $order = new WC_Order($emsOrder->getMerchantOrderId());
        ...
        if ($type == "webhook") {
            ...
            if ($emsOrder->Transactions()->current()->getStatus() == 'captured') {
        ...
        if ($emsOrder->status()->isCompleted() || $emsOrder->status()->isProcessing()) {
