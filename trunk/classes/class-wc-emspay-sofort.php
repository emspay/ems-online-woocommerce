...
class WC_Emspay_Sofort extends WC_Emspay_Gateway
{
    ...
    public function __construct()
    {
        ...
        $this->method_title = __('EMS PAY - SOFORT', WC_Emspay_Helper::DOMAIN);
        $this->method_description = __('EMS PAY - SOFORT', WC_Emspay_Helper::DOMAIN);
    ...
    public function process_payment($order_id)
    {
        ...
        $emsOrder = $this->ems->createSofortOrder(
